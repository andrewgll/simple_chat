defmodule SimpleChat.Accounts.User do
  use Ecto.Schema
  ...
  defp maybe_validate_unique_username(changeset, opts) do
    if Keyword.get(opts, :validate_username, true) do
      changeset
      |> unsafe_validate_unique(:username, SimpleChat.Repo)
  ...
  """
  def valid_password?(%SimpleChat.Accounts.User{hashed_password: hashed_password}, password)
