defmodule SimpleChat.Accounts do
  @moduledoc """
  ...
  alias SimpleChat.Accounts.{User, UserToken, UserNotifier}
  ...
  def deliver_user_update_username_instructions(
    ...
    UserNotifier.deliver_update_username_instructions(
      user,
      update_username_url_fun.(encoded_token)
    )
  end
