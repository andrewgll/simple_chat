...
config :simple_chat, SimpleChatWeb.Endpoint,
  ...
  live_view: [signing_salt: "7GqkgE3F"]

# Configures the mailer
#
# By default it uses the "Local" adapter which stores the usernames
# locally. You can see the usernames in your browser, at "/dev/mailbox".
#
